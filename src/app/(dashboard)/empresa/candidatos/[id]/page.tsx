...
export default async function EmpresaCandidatoDetailPage({
  ...
  return (
    <div className="max-w-4xl">
      <div className="mb-6">
        <Link href="/empresa/candidatos" className="text-sm text-[#6B7280] hover:text-[#052E16] flex items-center gap-1 mb-4 transition-colors">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 flex flex-col gap-4">
          ...
          <Card padding="md">
            <h2 className="text-base font-bold text-[#052E16] mb-3">Sobre o candidato</h2>
        ...
        <div className="flex flex-col gap-4">
          ...
          <Card padding="md">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link href={`/empresa/vagas/${job?.id}`} className="text-xs text-[#16A34A] hover:underline">
                Ver vaga
              </Link>
            </div>
          </Card>
          ...
          <Card padding="md">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex flex-col gap-0.5">
                <span className="text-xs text-[#9CA3AF]">Recebido em</span>
